import "./App.css";
import getUrlShorten from "../src/actions/index.js";
import Hero from "./components/Hero";
import NavBar from "./components/NavBar";
import { useEffect, useState } from "react";
import { LinkShorted } from "./components/LinkShorted";

import imgReco from "../public/icon-brand-recognition.svg";
import imgRecords from "../public/icon-detailed-records.svg";
import imgCustom from "../public/icon-fully-customizable.svg";
import Logo from "/../public/logo.svg";
import imgFace from "../public/icon-facebook.svg";
import imgTwit from "../public/icon-twitter.svg";
import imgPinte from "../public/icon-pinterest.svg";
import imgInsta from "../public/icon-instagram.svg";
...
function App() {
  ...
  const handleData = async (e) => {
    e.preventDefault();
    const fetchData = getUrlShorten(dataUrl);

    const showData = await fetchData;
    setData((prevState) => [
      ...prevState,
      {
        originalLink: showData.result.original_link,
        shortedLink: showData.result.full_short_link,
      },
    ]);
  ...
  return (
    <div className="">
      <NavBar />
      <Hero />
      <div className="bg-graySoft mt-[7rem] min-h-[100vh]  pb-8">
        <form
          className="mx-4  p-4 rounded-lg flex flex-col gap-2 text-center bg-[url(../../public/bg-shorten-mobile.svg)] bg-no-repeat bg-contain bg-darkViolet bg-right relative -top-14 xl:bg-[url(../../public/bg-shorten-desktop.svg)] xl:mx-24 xl:flex-row xl:bg-cover xl:p-10 xl:gap-4"
          id="form"
        >
          <input
            className="rounded-sm mb-2 text-xs p-2 xl:rounded-md xl:basis-4/5 xl:p-4 xl:text-sm"
            type="text"
          ...
          <button
            onClick={handleData}
            className="bg-cyanCustom text-white rounded-sm mb-2 text-xs p-2 xl:rounded-md xl:basis-1/5 xl:p-0 xl:text-sm"
          >
            Shorten it!
          </button>
        </form>
        <LinkShorted links={data} />
        <div className="text-center xl:w-2/5 xl:mx-auto xl:mb-16">
          <h2 className="mb-4 font-bold text-veryDarkViolet xl:text-4xl">
            Advanced Statistics
          </h2>
        ...
        <div className="mt-10 pseudo-element relative xl:grid xl:grid-cols-6 xl:px-24 xl:grid-rows-[repeat(6, minmax(0, 25px))] xl:pb-0">
          <div className="bg-white mx-4 rounded-md text-center p-2 relative mb-16 xl:col-start-1 xl:col-span-2 xl:row-start-1 xl:row-span-4 xl:py-4">
            <div className="bg-darkViolet w-16 p-[14px] rounded-full mx-auto relative -top-12 xl:-left-[100px]">
              <img
                className="bg-darkViolet mx-auto w-12 "
                src={imgReco}
                alt="recognition"
              />
            </div>
            <h3 className="font-bold text-veryDarkViolet mb-4">
              Brand Recognition
            </h3>
            <p className="text-grayishViolet">
          ...
          <div className="bg-white mx-4 rounded-md text-center p-2 relative mb-16 xl:col-start-3 xl:col-span-2 xl:row-start-2 xl:row-span-4 ">
            <div className="bg-darkViolet w-16 p-[14px] rounded-full mx-auto relative -top-12 xl:-left-[100px]">
              <img
                className="bg-darkViolet mx-auto w-12 "
                src={imgRecords}
          ...
          <div className="bg-white mx-4 rounded-md text-center p-2 relative mb-16 xl:col-start-5 xl:col-span-2 xl:row-start-3 xl:row-span-4">
            <div className="bg-darkViolet w-16 p-[14px] rounded-full mx-auto relative -top-12 xl:-left-[100px]">
              <img
                className="bg-darkViolet mx-auto w-12 "
                src={imgCustom}
      ...
      <div className="text-center bg-[url(../../public/bg-boost-mobile.svg)] bg-no-repeat bg-cover bg-right bg-darkViolet px-2 py-4 h-52 flex justify-center flex-col xl:bg-[url(../../public/bg-boost-desktop.svg)] ">
        <h3 className="text-white font-bold xl:text-3xl">
          Boost your links today
        </h3>
        <button className="bg-cyanCustom rounded-full px-6 py-2 text-white mt-4 w-50 text-center mx-auto">
          Get Started
        </button>
      </div>
      <footer className="bg-veryDarkViolet p-8 text-center xl:flex xl:justify-between xl:px-24">
        <div className="">
          <svg
            className="mx-auto"
        ...
        <div className="xl:flex xl:gap-10 xl:items-start">
          <div className="mt-6 xl:mt-0">
            <h4 className="text-graySoft mb-4 font-bold">Features</h4>
            <ul className="text-grayCustom ">
          ...
          <div className="mt-6 xl:mt-0">
            <h4 className="text-graySoft mb-4 font-bold">Resources</h4>
            <ul className="text-grayCustom ">
              <li>Blog</li>
              <li>Developers</li>
              <li>Support</li>
          ...
          <div className="mt-6 xl:mt-0">
            <h4 className="text-graySoft mb-4 font-bold">Company</h4>
            <ul className="text-grayCustom">
              <li>About</li>
              <li>Our Team</li>
              <li>Careers</li>
          ...
          <div className="mt-6 flex justify-center gap-6 xl:mt-0">
            <img src={imgFace} alt="logo facebook" className="xl:w-6 xl:h-6" />
            <img src={imgTwit} alt="logo twitter" className="xl:w-6 xl:h-6" />
            <img
              src={imgPinte}
              alt="logo pinterest"
